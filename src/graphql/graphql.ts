...
export type AuthenticateMutation = { __typename?: 'Mutation', authenticate: { __typename?: 'AuthenticatePayload', isSuccess: boolean, user?: { __typename?: 'User', email: string } | null, errors?: Array<{ __typename?: 'IncorrectCredentialsError', message: string } | { __typename?: 'TooManyAttemptsError', message: string }> | null } };
