...
export type SignInMutation = { __typename?: 'Mutation', authenticate: { __typename?: 'AuthenticatePayload', isSuccess: boolean, errors?: Array<{ __typename?: 'IncorrectCredentialsError', message: string } | { __typename?: 'TooManyAttemptsError', message: string }> | null } };
